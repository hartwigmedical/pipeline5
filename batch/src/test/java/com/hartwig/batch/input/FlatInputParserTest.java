...
public class FlatInputParserTest {
    ...
    public void shouldReadInputsDiscardingBlankLinesAndDuplicates() {
        ...
        assertThat(parsed.get(0).get().inputValue()).isEqualTo("gs://some-bucket/some-file");
        assertThat(parsed.get(1).get().inputValue()).isEqualTo("gs://some-bucket/some-other-file");
    }
}
...
public class RefGenome38PlusAltResourceFiles implements ResourceFiles {

    public RefGenomeVersion version() {
        return RefGenomeVersion.V38_ALT;
    }
    ...
    public String refGenomeFile() {
        return VmDirectories.RESOURCES + "/" + REFERENCE_GENOME + "/38_full_plus_decoy/GRCh38_full_analysis_set_plus_decoy_hla_phix174.fa";
    }

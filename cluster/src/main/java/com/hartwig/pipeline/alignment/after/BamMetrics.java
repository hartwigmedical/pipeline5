...
public class BamMetrics {
    ...
    BamMetrics(final Arguments arguments, final ComputeEngine executor, final Storage storage) {
    ...
    public BamMetricsOutput run(AlignmentOutput alignmentOutput) {
        ...
        executor.submit(bucket, VirtualMachineJobDefinition.bamMetrics(startup));
        return null;
    }
}

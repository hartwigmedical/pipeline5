...
public class RunTool {
    ...
    private void execute() throws Exception {
        SampleCluster cluster = new GoogleDataprocCluster(GoogleCredentials.getApplicationDefault(),
        ...
        cluster.submit(SparkJobDefinition.tool(jarLocation.uri(), performanceProfile, "com.hartwig.pipeline.runtime.tools.FastQReadCount"),
                arguments);

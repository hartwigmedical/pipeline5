...
public class InputDownloadCommandTest {

    private InputDownloadCommand victim;
    ...
    public void setUp() throws Exception {
        ...
        bucket = "test";
        victim = new InputDownloadCommand(GoogleStorageLocation.of(bucket, remoteSourcePath));
    }
    ...
    public void supportsCopyingOfInputDirectories() {
        victim = new InputDownloadCommand(GoogleStorageLocation.of(bucket, "path/to/input/dir", true));

...
public class LinxSomaticTest extends TertiaryStageTest<LinxSomaticOutput> {
    ...
    protected List<String> expectedCommands() {
        ...
        commands.add("java -Xmx8G -jar /opt/tools/linx/1.23.4/linx.jar -sample tumor -sv_vcf "
        ...
        commands.add("java -Xmx8G -cp /opt/tools/linx/1.23.4/linx.jar com.hartwig.hmftools.linx.visualiser.SvVisualiser "

...
public class PurpleTest extends TertiaryStageTest<PurpleOutput> {
    ...
    protected List<String> expectedCommands() {
        return Collections.singletonList(
                "java -Xmx20G -jar /opt/tools/purple/3.4.2/purple.jar -amber /data/input/results -cobalt /data/input/results "
    ...
    protected List<String> expectedReferenceOnlyCommands() {
        return Collections.singletonList(
                "java -Xmx20G -jar /opt/tools/purple/3.4.2/purple.jar -amber /data/input/results -cobalt /data/input/results -ref_genome "

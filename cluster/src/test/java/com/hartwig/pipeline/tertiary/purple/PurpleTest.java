    ...
    protected List<String> expectedCommands() {
        return Collections.singletonList(
                "java -Xmx12G -jar /opt/tools/purple/2.51/purple.jar -reference reference -tumor tumor -output_dir "
                        ...
                        + "-driver_catalog -hotspots /opt/resources/sage/hg37/KnownHotspots.somatic.hg19.vcf.gz "
                        + "-driver_gene_panel /opt/resources/gene_panel/hg37/DriverGenePanel.hg19.tsv "

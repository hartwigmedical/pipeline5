...
public class PurpleTest extends TertiaryStageTest<PurpleOutput> {
    ...
    protected List<String> expectedCommands() {
        return Collections.singletonList(
                "java -Xmx12G -jar /opt/tools/purple/2.49/purple.jar -reference reference -tumor tumor -output_dir "
    ...
    public void shallowModeUsesLowDepthSettings() {
        ...
        assertThat(victim.commands(input()).get(0).asBash()).contains(
                "-highly_diploid_percentage 0.88 -somatic_min_variants 100 -somatic_min_purity_spread 0.1");
    }

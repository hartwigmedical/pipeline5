...
public class PaveGermlineTest extends StageTest<PaveOutput, SomaticRunMetadata> {
    ...
    protected Stage<PaveOutput, SomaticRunMetadata> createVictim() {
        return new PaveGermline(TestInputs.REF_GENOME_37_RESOURCE_FILES, TestInputs.sageGermlineOutput(), new NoopPersistedDataset());
    }

    @Override
    protected List<String> expectedCommands() {
        return ImmutableList.of(
                "java -Xmx16G -jar /opt/tools/pave/1.1/pave.jar -sample tumor -vcf_file /data/input/tumor.germline.vcf.gz -output_dir "

...
public class LinxGermlineTest extends TertiaryStageTest<LinxGermlineOutput> {
    ...
    protected List<String> expectedCommands() {
        ...
        commands.add("java -Xmx8G -jar /opt/tools/linx/1.18.1/linx.jar -sample tumor -germline "
                + "-sv_vcf /data/input/tumor.gripss.filtered.vcf.gz -ref_genome_version 37 -output_dir /data/output "

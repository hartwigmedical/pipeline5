...
public class LinxTest extends TertiaryStageTest<LinxOutput> {
    ...
    protected List<String> expectedCommands() {
        return Collections.singletonList("java -Xmx8G -jar /opt/tools/linx/1.10/linx.jar -sample tumor -sv_vcf "
                + "/data/input/tumor.purple.sv.vcf.gz -purple_dir /data/input/results "
                + "-ref_genome /opt/resources/reference_genome/hg19/Homo_sapiens.GRCh37.GATK.illumina.fasta -ref_genome_version 37 "
                ...
                + "-gene_transcripts_dir /opt/resources/ensembl/hg19/ensembl_data_cache -check_fusions -known_fusion_file "
                + "/opt/resources/knowledgebases/hg19/known_fusion_data.csv -chaining_sv_limit 0 -check_drivers -write_vis_data");
    }

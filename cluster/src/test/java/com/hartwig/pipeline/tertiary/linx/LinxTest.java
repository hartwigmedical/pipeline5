...
public class LinxTest extends TertiaryStageTest<LinxOutput> {
    ...
    protected List<String> expectedCommands() {
        return Collections.singletonList("java -Xmx8G -jar /opt/tools/linx/1.12/linx.jar -sample tumor -sv_vcf "
                ...
                + "-ref_genome /opt/resources/reference_genome/hg37/Homo_sapiens.GRCh37.GATK.illumina.fasta -ref_genome_version HG37 "
                ...
                + "-gene_transcripts_dir /opt/resources/ensembl/hg37/ensembl_data_cache "
                + "-check_fusions -known_fusion_file /opt/resources/knowledgebases/hg37/known_fusion_data.csv "
                + "-check_drivers -driver_gene_panel /opt/resources/gene_panel/hg37/DriverGenePanel.hg19.tsv "

...
public class LinxTest extends TertiaryStageTest<LinxOutput> {
    ...
    protected List<String> expectedCommands() {
        return Collections.singletonList("java -Xmx8G -jar /opt/tools/linx/1.10/linx.jar -sample tumor -sv_vcf "
                ...
                + "-gene_transcripts_dir /opt/resources/ensembl/hg37/ensembl_data_cache -check_fusions -known_fusion_file "
                + "/opt/resources/knowledgebases/hg37/known_fusion_data.csv -chaining_sv_limit 0 -check_drivers -write_vis_data");
    }

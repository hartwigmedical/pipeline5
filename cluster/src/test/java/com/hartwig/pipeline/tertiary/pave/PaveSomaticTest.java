...
public class PaveSomaticTest extends StageTest<PaveOutput, SomaticRunMetadata> {
    ...
    protected Stage<PaveOutput, SomaticRunMetadata> createVictim() {
        return new PaveSomatic(TestInputs.REF_GENOME_37_RESOURCE_FILES,
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of(toolCommand(PAVE) + " -sample tumor " + "-vcf_file /data/input/tumor.somatic.vcf.gz "

...
public class SnpGenotypeTest extends StageTest<SnpGenotypeOutput, SingleSampleRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        ...
        commands.add("/usr/lib/jvm/java-8-openjdk-amd64/jre/bin/java -Xmx20G -jar /opt/tools/gatk/3.8.0/GenomeAnalysisTK.jar -T UnifiedGenotyper -nct $(grep -c '^processor' /proc/cpuinfo) "

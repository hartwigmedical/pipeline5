...
public class GripssSomaticTest extends SubStageTest {
    ...
    public void expectedOutput() {
        assertThat(bash()).contains("java -Xmx24G -cp /opt/tools/gripss/2.0/gripss.jar com.hartwig.hmftools.gripsskt.GripssApplicationKt "

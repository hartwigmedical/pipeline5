...
public class SageV2PonFilterTest extends SubStageTest {
    ...
    public void runsTwoPipedBcfToolsFilterCommandInSubshell() {
        assertThat(bash()).contains("("
                ...
                + "/opt/tools/bcftools/1.3.1/bcftools filter -e 'PON_COUNT!=\".\" && INFO/TIER=\"PANEL\" && PON_MAX>=5 && PON_COUNT >= 6' -s SAGE_PON -m+ -O u | "
                + "/opt/tools/bcftools/1.3.1/bcftools filter -e 'PON_COUNT!=\".\" && INFO/TIER!=\"HOTSPOT\" && INFO/TIER!=\"PANEL\" && PON_COUNT >= 6' -s SAGE_PON -m+ "

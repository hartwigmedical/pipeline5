...
public class SageV2CallerTest extends TertiaryStageTest<SageV2CallerOutput> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("unzip -d /opt/resources /opt/resources/snpeff/hg37/snpEff_v4_3_GRCh37.75.zip",
                ...
                "(/opt/tools/bcftools/1.3.1/bcftools annotate -a /opt/resources/sage/hg37/SageGermlinePon.hg19.vcf.gz -c PON_COUNT /data/output/tumor.mappability.annotated.vcf.gz -O z -o /data/output/tumor.sage.pon.annotated.vcf.gz)",

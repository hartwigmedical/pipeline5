...
public class SageCallerTest extends TertiaryStageTest<SomaticCallerOutput> {
    ...
    protected Stage<SomaticCallerOutput, SomaticRunMetadata> createVictim() {
        return new SageCaller(TestInputs.defaultPair(), TestInputs.HG37_RESOURCE_FILES);
    }
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("unzip -d /opt/resources /opt/resources/snpeff/hg37/snpEff_v4_3_GRCh37.75.zip",
                ...
                "/opt/tools/snpEff/4.3s/snpEff.sh /opt/tools/snpEff/4.3s/snpEff.jar /opt/resources/snpeff/hg37/snpEff.config GRCh37.75 /data/output/tumor.sage.pon.filter.vcf.gz /data/output/tumor.snpeff.annotated.vcf",

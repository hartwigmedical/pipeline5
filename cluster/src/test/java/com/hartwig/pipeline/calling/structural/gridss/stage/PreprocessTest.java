...
import static com.hartwig.pipeline.calling.structural.gridss.GridssTestConstants.REFERENCE_SAMPLE;
...
public class PreprocessTest extends SubStageTest {
    ...
    private String inputBamFullPath = inFile(inputBamFilename);

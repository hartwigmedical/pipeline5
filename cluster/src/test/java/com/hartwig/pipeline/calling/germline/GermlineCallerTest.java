...
public class GermlineCallerTest extends StageTest<GermlineCallerOutput, SingleSampleRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.<String>builder().add("unzip -d /data/resources /data/resources/database.zip",
                ...
                "java -Xmx29G -jar $TOOLS_DIR/gatk/3.8.0/GenomeAnalysisTK.jar -T CombineVariants -V /data/output/reference.filtered_snp.vcf -V /data/output/reference.filtered_indels.vcf -o /data/output/reference.filtered_variants.vcf -R /data/resources/reference.fasta --assumeIdenticalSamples",
                ...
                "(java -Xmx29G -jar $TOOLS_DIR/snpEff/4.3s/SnpSift.jar annotate -c /data/resources/snpeff.config -tabix -name GoNLv5_ -info AF,AN,AC /data/resources/gonl.vcf.gz /data/output/reference.cosmic.annotated.vcf.gz > /data/output/reference.gonlv5.annotated.vcf)",

...
public class GermlineCallerTest extends StageTest<GermlineCallerOutput, SingleSampleRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.<String>builder().add("unzip -d /data/resources /data/resources/database.zip",
                ...
                "java -Xmx29G -jar $TOOLS_DIR/gatk/3.8.0/GenomeAnalysisTK.jar -T SelectVariants -selectType INDEL -selectType MIXED -R /data/resources/reference.fasta -V /data/output/reference.filtered_snp.vcf -o /data/output/reference.raw_indels.vcf",
                ...
                "java -Xmx29G -jar $TOOLS_DIR/gatk/3.8.0/GenomeAnalysisTK.jar -T CombineVariants -V /data/output/reference.filtered_indels.vcf -V /data/output/reference.filtered_snp.vcf -o /data/output/reference.filtered_variants.vcf -R /data/resources/reference.fasta --assumeIdenticalSamples",

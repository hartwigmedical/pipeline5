...
public class GatkHaplotypeCallerTest {
    ...
    public void shouldGenerateCorrectCommandFromArguments() {
        ...
        String expected = "java -Xmx20G -jar /data/tools/GenomeAnalysisTK.jar -T HaplotypeCaller --input_file " + inputBam
        ...
        assertThat(new GatkHaplotypeCaller(inputBam, referenceFasta, outputVcf).asBash()).isEqualTo(expected);
    }

...
public class StructuralCallerTest extends StageTest<StructuralCallerOutput, SomaticRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("export PATH=\"${PATH}:/opt/tools/bwa/0.7.17\"",
                ...
                "java -Xmx32G -Dsamjdk.create_index=true -Dsamjdk.use_async_io_read_samtools=true -Dsamjdk.use_async_io_write_samtools=true -Dsamjdk.use_async_io_write_tribble=true -Dsamjdk.buffer_size=4194304 -cp /opt/tools/gridss/2.8.3/gridss.jar picard.vcf.SortVcf I=/data/output/tumor.repeatmasker_annotation.withbealn.vcf I=/data/output/tumor.repeatmasker_annotation.withannotation.vcf O=/data/output/tumor.viral_annotation.vcf.gz",

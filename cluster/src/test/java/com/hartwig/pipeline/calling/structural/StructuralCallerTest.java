    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("export PATH=\"${PATH}:/opt/tools/bwa/0.7.17\"",
                ...
                "/opt/tools/gridss/2.11.1/gridss.sh --output /data/output/tumor.gridss.driver.vcf.gz --assembly /data/output/tumor"
                        ...
                        + ".GATK.illumina.fasta --jar /opt/tools/gridss/2.11.1/gridss.jar --blacklist /opt/resources/gridss_repeatmasker_db/37/ENCFF001TDO.37.bed --configuration /opt/resources/gridss_config/gridss.properties --labels reference,tumor --jvmheap 31G --picardoptions VALIDATION_STRINGENCY=LENIENT --externalaligner /data/input/reference.bam /data/input/tumor.bam",

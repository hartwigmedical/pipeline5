...
public class StructuralCallerTest extends StageTest<StructuralCallerOutput, SomaticRunMetadata> {
    ...
    protected Stage<StructuralCallerOutput, SomaticRunMetadata> createVictim() {
        return new StructuralCaller(TestInputs.defaultPair(), TestInputs.HG37_RESOURCE_FILES, persistedDataset);
    }
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("export PATH=\"${PATH}:/opt/tools/bwa/0.7.17\"",
                ...
                "/opt/tools/gridss/2.9.4/gridss.sh -o /data/output/tumor.gridss.driver.vcf.gz -a /data/output/tumor.assembly.bam -w /data/output -r /opt/resources/reference_genome/hg37/Homo_sapiens.GRCh37.GATK.illumina.fasta -j /opt/tools/gridss/2.9.4/gridss.jar -b /opt/resources/gridss_repeatmasker_db/hg37/ENCFF001TDO.bed -c /opt/resources/gridss_config/gridss.properties --repeatmaskerbed /opt/resources/gridss_repeatmasker_db/hg37/hg19.fa.out.bed --labels reference,tumor --jvmheap 31G /data/input/reference.bam /data/input/tumor.bam",

...
public class StructuralCallerTest extends StageTest<StructuralCallerOutput, SomaticRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("export PATH=\"${PATH}:/opt/tools/bwa/0.7.17\"",
                ...
                "java -Xmx2G -jar /opt/tools/picard/2.18.27/picard.jar SortVcf I=/data/output/reference_tumor.repeatmasker_annotation.withbealn.vcf I=/data/output/reference_tumor.repeatmasker_annotation.withannotation.vcf O=/data/output/reference_tumor.viral_annotation.vcf.gz",

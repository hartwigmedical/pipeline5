...
public class StructuralCallerTest extends StageTest<StructuralCallerOutput, SomaticRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of("export PATH=\"${PATH}:/opt/tools/bwa/0.7.17\"",
                ...
                "/opt/tools/gridss/2.7.2/gridss.sh -o /data/output/tumor.gridss.somatic.full.vcf -a /data/output/tumor.assembly.bam -w /data/output -r /opt/resources/reference_genome/Homo_sapiens.GRCh37.GATK.illumina.fasta/ -j /opt/tools/gridss/2.7.2/gridss.jar -b /opt/resources/gridss_config/ENCFF001TDO.bed/ -c /opt/resources/gridss_config/gridss.properties/ /data/input/reference.bam /data/input/tumor.bam",
                "/bin/bash -e /opt/tools/gridss/2.7.2/failsafe_repeatmasker_invoker.sh /data/output/tumor.gridss.somatic.full.vcf /data/output/tumor.repeatmasker_annotation.vcf.gz /opt/resources/gridss_repeatmasker_db/hg19.fa.out/ /opt/tools/gridss/2.7.2",
                ...
                "Rscript /opt/tools/gridss/2.7.2/gridss_somatic_filter.R -p /opt/resources/gridss_pon -i /data/output/tumor.viral_annotation.vcf -o /data/output/tumor.gridss.somatic.vcf -f /data/output/tumor.gridss.somatic.full.vcf -s /opt/tools/gridss/2.7.2",

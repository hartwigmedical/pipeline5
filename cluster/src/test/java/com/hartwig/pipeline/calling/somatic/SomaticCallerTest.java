...
public class SomaticCallerTest extends TertiaryStageTest<SomaticCallerOutput> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of(
                "java -Xmx8G -cp /opt/tools/sage/2.2/sage.jar com.hartwig.hmftools.sage.SageHotspotApplication -tumor tumor -tumor_bam /data/input/tumor.bam -reference reference -reference_bam /data/input/reference.bam -known_hotspots /opt/resources/sage/KnownHotspots.tsv -coding_regions /opt/resources/sage/CodingRegions.bed -ref_genome /opt/resources/reference_genome/hg37/Homo_sapiens.GRCh37.GATK.illumina.fasta -out /data/output/tumor.sage.hotspots.vcf.gz",
                "/opt/tools/tabix/0.2.6/tabix /data/output/tumor.sage.hotspots.vcf.gz -p vcf",
                "(/opt/tools/bcftools/1.9/bcftools filter -i 'FILTER=\"PASS\"' /data/output/tumor.sage.hotspots.vcf.gz -O u | /opt/tools/bcftools/1.9/bcftools annotate -x INFO/HOTSPOT -O u | /opt/tools/bcftools/1.9/bcftools annotate -x FILTER/LOW_CONFIDENCE -O u | /opt/tools/bcftools/1.9/bcftools annotate -x FILTER/GERMLINE_INDEL -O u | /opt/tools/bcftools/1.9/bcftools view -s tumor -O z -o /data/output/tumor.sage.hotspots.filtered.vcf.gz)",
                "/opt/tools/tabix/0.2.6/tabix /data/output/tumor.sage.hotspots.filtered.vcf.gz -p vcf",
                "(/opt/tools/bcftools/1.9/bcftools annotate -a /opt/resources/sage/SAGE_PON.vcf.gz -c SAGE_PON_COUNT /data/output/tumor.sage.hotspots.filtered.vcf.gz -O z -o /data/output/tumor.sage.hotspots.pon.annotated.vcf.gz)",
                "/opt/tools/tabix/0.2.6/tabix /data/output/tumor.sage.hotspots.pon.annotated.vcf.gz -p vcf",
                "(/opt/tools/bcftools/1.9/bcftools filter -e 'SAGE_PON_COUNT!=\".\" && MIN(SAGE_PON_COUNT) > 0' -s SAGE_PON -m+ /data/output/tumor.sage.hotspots.pon.annotated.vcf.gz -O z -o /data/output/tumor.sage.pon.filter.vcf.gz)",
                ...
                "(/opt/tools/bcftools/1.9/bcftools annotate -a /opt/resources/mappability/hg37/out_150_hg19.mappability.bed.gz -h /opt/resources/mappability/mappability.hdr -c CHROM,FROM,TO,-,MAPPABILITY /data/output/tumor.strelka.vcf -O z -o /data/output/tumor.mappability.annotated.vcf.gz)",
                "/opt/tools/tabix/0.2.6/tabix /data/output/tumor.mappability.annotated.vcf.gz -p vcf",
                "(/opt/tools/bcftools/1.9/bcftools annotate -a /opt/resources/pon/GERMLINE_PON.vcf.gz -c GERMLINE_PON_COUNT /data/output/tumor.mappability.annotated.vcf.gz -O z -o /data/output/tumor.germline.pon.annotated.vcf.gz)",
                "/opt/tools/tabix/0.2.6/tabix /data/output/tumor.germline.pon.annotated.vcf.gz -p vcf",
                "(/opt/tools/bcftools/1.9/bcftools annotate -a /opt/resources/pon/SOMATIC_PON.vcf.gz -c SOMATIC_PON_COUNT /data/output/tumor.germline.pon.annotated.vcf.gz -O z -o /data/output/tumor.somatic.pon.annotated.vcf.gz)",
                ...
                "(/opt/tools/bcftools/1.9/bcftools filter -e 'GERMLINE_PON_COUNT!= \".\" && MIN(GERMLINE_PON_COUNT) > 5' -s GERMLINE_PON -m+ /data/output/tumor.strelka.post.processed.vcf.gz -O u | /opt/tools/bcftools/1.9/bcftools filter -e 'SOMATIC_PON_COUNT!=\".\" && MIN(SOMATIC_PON_COUNT) > 3' -s SOMATIC_PON -m+ -O z -o /data/output/tumor.pon.filtered.vcf.gz)",
                "/opt/tools/tabix/0.2.6/tabix /data/output/tumor.pon.filtered.vcf.gz -p vcf",
                "java -Xmx8G -cp /opt/tools/sage/2.2/sage.jar com.hartwig.hmftools.sage.SageHotspotAnnotation -source_vcf /data/output/tumor.pon.filtered.vcf.gz -hotspot_vcf /data/output/tumor.sage.pon.filter.vcf.gz -known_hotspots /opt/resources/sage/KnownHotspots.tsv -out /data/output/tumor.sage.hotspots.annotated.vcf.gz",
                ...
                "(/opt/tools/bcftools/1.9/bcftools annotate -a /opt/resources/cosmic_v85/CosmicCodingMuts_v85_collapsed.vcf.gz -c ID,INFO /data/output/tumor.snpeff.annotated.vcf.gz -O z -o /data/output/tumor.cosmic.annotated.final.vcf.gz)",

...
public class SomaticCallerTest extends TertiaryStageTest<SomaticCallerOutput> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of(
                ...
                "/opt/tools/bcftools/1.3.1/bcftools annotate -a /opt/resources/dbNSFP_v2.9/dbNSFP2.9.txt.gz/ -c ID -o /data/output/tumor.dbsnp.annotated.vcf.gz -O z /data/output/tumor.snpeff.annotated.vcf.gz",

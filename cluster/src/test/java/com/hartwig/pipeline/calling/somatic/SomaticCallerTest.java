...
public class SomaticCallerTest extends TertiaryStageTest<SomaticCallerOutput> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of(
                ...
                "java -Xmx20G -jar $TOOLS_DIR/strelka-post-process/1.4/strelka-post-process.jar -v /data/output/tumor.somatic.pon.annotated.vcf.gz -hc_bed /data/resources/strelka-post-process.bed -t tumor -o /data/output/tumor.strelka.post.processed.vcf.gz -b /data/input/tumor.bam",

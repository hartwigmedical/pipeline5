...
public class StructuralCallerPostProcessTest extends StageTest<StructuralCallerPostProcessOutput, SomaticRunMetadata> {
    ...
    protected List<String> expectedCommands() {
        return ImmutableList.of(
                "java -Xmx24G -cp /opt/tools/gripss/1.9/gripss.jar com.hartwig.hmftools.gripss.GripssApplicationKt -ref_genome "
                ...
                "java -Xmx24G -cp /opt/tools/gripss/1.9/gripss.jar com.hartwig.hmftools.gripss.GripssHardFilterApplicationKt -input_vcf /data/output/"

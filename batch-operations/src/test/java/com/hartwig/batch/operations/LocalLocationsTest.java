...
public class LocalLocationsTest {
    ...
    public void testDownloadReferenceAlignmentIndex() {
        ...
        assertEquals(commands.get(0).asBash(), "gsutil -qm cp -r -n gs://alignment/171006_COLO829/COLO929v003R.cram /data/input/COLO929v003R.cram");
        assertEquals(commands.get(1).asBash(), "gsutil -qm cp -r -n gs://alignment/171006_COLO829/COLO929v003R.crai /data/input/COLO929v003R.crai");
    }
    ...
    public void testDownloadTumorAlignmentIndex() {
        ...
        assertEquals(commands.get(0).asBash(), "gsutil -qm cp -r -n gs://alignment/171006_COLO829/COLO929v003T.cram /data/input/COLO929v003T.cram");
        assertEquals(commands.get(1).asBash(), "gsutil -qm cp -r -n gs://alignment/171006_COLO829/COLO929v003T.crai /data/input/COLO929v003T.crai");
    }
